...
public:
    ...
    NTSTATUS SetHook( ptr_t address, asmjit_::Assembler& hook );
    NTSTATUS Restore();
...
private:
    ...
    NTSTATUS SetHook32( ptr_t address, asmjit_::Assembler& hook );

    NTSTATUS SetHook64( ptr_t address, asmjit_::Assembler& hook );

...
NTSTATUS RemoteLocalHook::SetHook( ptr_t address, asmjit_::Assembler& hook )
{
    _address = address;
...
NTSTATUS RemoteLocalHook::SetHook32( ptr_t address, asmjit_::Assembler& hook )
{
...
NTSTATUS RemoteLocalHook::SetHook64( ptr_t /*address*/, asmjit_::Assembler& /*hook*/ )
{
    _hook64 = true;
